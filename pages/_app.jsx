...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/fS72UGCEXD",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=965432989360193566&permissions=8&scope=applications.commands%20bot",
    },
       {
      link: true,
      name: "Vote",
      ...
      href: "https://top.gg/bot/965432989360193566/vote",
    },
  ]
